...
def main():
    ...
    readme_text = st.markdown(get_file_content_as_string("instrucciones.md"))
        ...
        if sep is not None:  
            ...
            if train_prop is not None:                
                ...
                if st.checkbox('Ver Distribución de los conjuntos'):
                    ...
                    step2(data, training, testing)

def step2(data, training, testing):
    #------------------------------------------------- STEP 2 ----------------------------------------------------------
    ...
    if n is not None:
        ...
        step3(coherences_multiple_k, training, testing, n)

def step3(coherences_multiple_k, training, testing, n):
    #--------------------------------------------------------------- STEP 3 ---------------------------------------------------------------
    ...
    if h1 is not None:
        ...
        step4(n, training, testing, best_k, coherences_multiple_k)

def step4(n, training, testing, best_k, coherences_multiple_k):
    #----------------------------------------------------------------------- STEP 4 ----------------------------------------------------------
    ...
    if k_selected is not None:
        ...
        if h2 is not None:
            ...
            step5(training, best_k, k_selected)
def step5(training, best_k, k_selected):
    #------------------------------------------------------------- STEP 5 -------------------------------------------------------------- 
    ...
    if x_new != 0.0:
        ...
        if y_new != 0.0:
            ...
            st.write('Con K = ',best_k,' el nuevo punto pertenece a la clase ',best_predict[0],', con una confianza de: ',round(best_predict[1],2))
            st.write('Con K = ',k_selected,' el nuevo punto pertenece a la clase ',predict2[0],', con una confianza de: ',round(predict2[1],2))
main()
